                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <select name="bots_id" class="custom-select col-12 select2" id="bots_id" required autofocus>
                                        ...
                                        <?php $__currentLoopData = $edit_bots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bots): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php ($selected = ''); ?>
                                            <?php if(Request::old('bots_id') == ''): ?>
                                                <?php if($bots->id_bots == $edit_master_agents->bots_id): ?>
                                                    <?php ($selected = 'selected'); ?>
                                                <?php endif; ?>
                                            <?php else: ?>
                                                <?php if($bots->id_bots == Request::old('bots_id')): ?>
                                                    <?php ($selected = 'selected'); ?>
                                                <?php endif; ?>
                                            <?php endif; ?>

                                            <option value="<?php echo e($bots->id_bots); ?>" <?php echo e($selected); ?>><?php echo e($bots->name_bots.' - '.$bots->phone_number_bots); ?></option>
