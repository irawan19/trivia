                        ...
                        <?php if(Auth::user()->level_systems_id != '1'): ?>
                            <div style="text-align: center;">
                                ...
                                <?php ($get_admin = \App\Master_user::join('master_bots','bots_id','=','master_bots.id_bots')
                                                                    ->where('id',$id_admin)
                                                                    ->first()); ?>
                                <b style="font-size: 18px">BOT : <?php echo e($get_admin->name_bots.' - '.$get_admin->phone_number_bots); ?></b>
                                <br/>
                                <b style="font-size: 18px">Credit : <?php echo e($get_admin->credit_users); ?></b>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
