	        ...
	        <div class="col-12">
	            <div class="card">
	                <div class="card-body">
	                    <div class="row">
	                       	<div class="col-lg-12">
								<form method="GET" action="<?php echo e(URL('dashboard/list_game_report/search')); ?>" class="form-horizontal m-t-40">
	                    ...
	                    <table class="tablesaw table-striped table-hover table-bordered table" data-tablesaw-mode="columntoggle">
	                        ...
	                        <tbody>
	                        	<?php ($no_group = 1); ?>
	                        	<?php $__currentLoopData = $view_list_game_reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list_game_reports): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		                            <tr>
		                                <td><?php echo e($no_group.'. '.$list_game_reports->name_groups); ?></td>
		                                <td><?php echo e($list_game_reports->credit_groups); ?></td>
		                                <?php if(Auth::user()->level_systems_id != 3): ?>
		                                	<?php if(Auth::user()->level_systems_id == 1): ?>
		                                		<td colspan="5">
		                                			<?php ($id_master_agent 	= $list_game_reports->sub_users_id); ?>
		                                			<?php ($get_master_agent = \App\Master_user::where('id',$id_master_agent)->first()); ?>
		                                			<?php echo e($get_master_agent->name.' - '.$list_game_reports->name); ?>

		                                		</td>
		                                	<?php elseif(Auth::user()->level_systems_id == 2): ?>
		                                		<td colspan="5">
		                                			<?php echo e($list_game_reports->name); ?>
