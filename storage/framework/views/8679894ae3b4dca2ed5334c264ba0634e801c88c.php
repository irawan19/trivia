                ...
                <div class="card">
                    <div class="card-body">
    		            ...
    		            <form class="form-horizontal m-t-40" action="<?php echo e(URL('dashboard/sessions/processadd')); ?>" method="POST">
		                                ...
		                                <?php $__currentLoopData = $add_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groups): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php if($check_last_sessions == 0): ?>
    		                                	<?php if(Auth::user()->level_systems_id != 3): ?>
    			                                	...
    			                                	<option value="<?php echo e($groups->id_groups); ?>" <?php echo e(Request::old('groups_id') == $groups->id_groups ? $select='selected' : $select=''); ?>><?php echo e($get_master_agent->name.' - '.$get_agent->name.' | '.$groups->name_groups); ?></option>
    			                                <?php else: ?>
                            ...
                            <div class="form-group <?php echo e(Shwetech::errorStyleFormControl($errors->first('credit_member_sessions'))); ?>">
                                <label class="form-control-label">Credit Member <b style="color:red">*</b></label>
                                <input id="credit_member_sessions" type="text" name="credit_member_sessions" class="form-control number_format <?php echo e(Shwetech::errorStyleFormControl($errors->first('credit_member_sessions'))); ?>" value="<?php echo e(Request::old('credit_member_sessions')); ?>" placeholder="Credit Member" required>
