                ...
                <div class="card">
                    <div class="card-body">
    		            <form class="form-horizontal m-t-40" action="<?php echo e(URL('dashboard/sessions/processedit/'.$edit_sessions->id_sessions)); ?>" method="POST">
                            ...
                            <div class="form-group <?php echo e(Shwetech::errorStyleGroup($errors->first('credit_member_sessions'))); ?>">
                                <label class="form-control-label">Credit Member <b style="color:red">*</b></label>
                                <input id="credit_member_sessions" type="text" name="credit_member_sessions" class="form-control number_format <?php echo e(Shwetech::errorStyleFormControl($errors->first('credit_member_sessions'))); ?>" value="<?php echo e(Request::old('credit_member_sessions') == '' ? $edit_sessions->credit_member_sessions : Request::old('credit_member_sessions')); ?>" placeholder="Credit Member" required>
