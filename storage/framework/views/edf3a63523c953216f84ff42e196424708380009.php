		                                ...
		                                <?php $__currentLoopData = $add_sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sessions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		                                	...
		                                	<?php if($check_game == 0): ?>
			                                	<?php if(Auth::user()->level_systems_id != 3): ?>
				                                	...
				                                	<option value="<?php echo e($sessions->id_sessions); ?>" <?php echo e(Request::old('sessions_id') == $sessions->id_sessions ? $select='selected' : $select=''); ?>><?php echo e($get_master_agent->name.' - '.$get_agent->name.' | '.$get_agent->name_groups.' | '.$sessions->start_date_sessions.' - '.$sessions->end_date_sessions); ?></option>
				                                <?php else: ?>
