...
<?php $__env->startSection('content'); ?>
	...
	<div class="row page-titles">
	    <div class="col-md-5 align-self-center">
	        <h3 class="text-themecolor">Top Up Host</h3>
	    </div>
	    <div class="col-md-7 align-self-center">
	        <ol class="breadcrumb">
	            <li class="breadcrumb-item"><a href="<?php echo e(URL('dashboard')); ?>">Home</a></li>
	            <li class="breadcrumb-item active">Top Up Host</li>
	        </ol>
	    </div>
	</div>
	        ...
	        <div class="col-12">
	            <div class="card">
	                <div class="card-body">
	                    <div class="row">
	                       	<div class="col-lg-12">
								<form method="GET" action="<?php echo e(URL('dashboard/top_up_host/search')); ?>" class="form-horizontal m-t-40">
						...
						<br/>
						<div align="center"><?php echo e(Shwetech::add($link_top_up_host,'dashboard/top_up_host/add')); ?></div>
						<br/>
	                    <table class="tablesaw table-striped table-hover table-bordered table" data-tablesaw-mode="columntoggle">
	                        <thead>
	                            <tr>
	                                ...
	                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-sortable-default-col data-tablesaw-priority="4">Host</th>
	                        ...
	                        <tbody>
	                        	<?php ($no = 1); ?>
	                        	<?php $__currentLoopData = $view_top_up_hosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $top_up_hosts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		                            <tr>
		                                <td><?php echo e($no); ?></td>
		                                <td><?php echo e(Shwetech::changeDBToDate($top_up_hosts->date_top_ups)); ?></td>
		                                <td><?php echo e($top_up_hosts->time_top_ups); ?></td>
		                                <td><?php echo e($top_up_hosts->name); ?></td>
		                                <td><?php echo e($top_up_hosts->phone_number_users); ?></td>
		                                <td><?php echo e($top_up_hosts->credit_top_ups); ?></td>
		                                <td width="5%">
		                                	<div class="input-group">
												<div class="input-group-btn">
													...
													<div class="dropdown-menu dropdown-menu-right action">
														<?php echo e(Shwetech::read($link_top_up_host,'dashboard/top_up_host/read/'.$top_up_hosts->id_top_ups)); ?>

														<?php echo e(Shwetech::edit($link_top_up_host,'dashboard/top_up_host/edit/'.$top_up_hosts->id_top_ups)); ?>

														<?php echo e(Shwetech::delete($link_top_up_host,'dashboard/top_up_host/delete/'.$top_up_hosts->id_top_ups,$top_up_hosts->name)); ?>
