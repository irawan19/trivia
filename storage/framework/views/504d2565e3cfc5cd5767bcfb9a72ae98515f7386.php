	        ...
	        <div class="col-12">
	            <div class="card">
	                <div class="card-body">
	                    <div class="row">
	                       	<div class="col-lg-12">
								<form method="GET" action="<?php echo e(URL('dashboard/master_agent/search')); ?>" class="form-horizontal m-t-40">
						...
						<br/>
						<div align="center"><?php echo e(Shwetech::add($link_master_agent,'dashboard/master_agent/add')); ?></div>
						<br/>
	                    <table class="tablesaw table-striped table-hover table-bordered table" data-tablesaw-mode="columntoggle">
	                        ...
	                        <tbody>
	                        	<?php ($no = 1); ?>
	                        	<?php $__currentLoopData = $view_master_agents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $master_agents): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		                            <tr>
		                                <td><?php echo e($no); ?></td>
		                                	...
		                                	<div class="input-group">
												<div class="input-group-btn">
													...
													<div class="dropdown-menu dropdown-menu-right action">
														<?php echo e(Shwetech::read($link_master_agent,'dashboard/master_agent/read/'.$master_agents->id)); ?>

														<?php echo e(Shwetech::edit($link_master_agent,'dashboard/master_agent/edit/'.$master_agents->id)); ?>

														<?php ($check_agent = \App\Master_user::where('sub_users_id',$master_agents->id)->count()); ?>
														<?php if($check_agent == 0): ?>
															<?php echo e(Shwetech::delete($link_master_agent,'dashboard/master_agent/delete/'.$master_agents->id,$master_agents->name)); ?>
