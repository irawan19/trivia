								...
								<form method="GET" action="<?php echo e(URL('dashboard/sessions/search')); ?>" class="form-horizontal m-t-40">
									...
									<div class="input-group">
										<?php if(Auth::user()->level_systems_id == 1): ?>
											<select name="search_host" class="custom-select" id="inlineFormCustomSelect" required autofocus>
			                                    <?php ($selected_none = ''); ?>
		                                        <?php if($result_host == 0): ?>
		                                             <?php ($selected_none = 'selected'); ?>
		                                        <?php endif; ?>
			                                    <option value="0" <?php echo e($selected_none); ?>>All</option>
			                                    <?php $__currentLoopData = $view_host; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $host): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			                                    	<?php ($selected = ''); ?>
			                                    	<?php if($host->id == $result_host): ?>
			                                    		<?php ($selected = 'selected'); ?>
			                                    	<?php endif; ?>
			                                    	<?php if(Auth::user()->level_systems_id == 1): ?>
			                                    		<?php ($get_agent = \App\Master_user::where('id',$host->sub_users_id)->first()); ?>
			                                    		<option value="<?php echo e($host->id); ?>" <?php echo e($selected); ?> ><?php echo e($get_agent->name); ?> - <?php echo e($host->name); ?></option>
			                                    	<?php elseif(Auth::user()->level_systems_id == 2): ?>
			                                    		<option value="<?php echo e($host->id); ?>" <?php echo e($selected); ?> ><?php echo e($host->name); ?></option>
			                                    	<?php endif; ?>
	                    ...
	                    <table class="tablesaw table-striped table-hover table-bordered table" data-tablesaw-mode="columntoggle">
	                        <thead>
	                            <tr>
	                                ...
	                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-sortable-default-col data-tablesaw-priority="5">Max Members</th>
	                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-sortable-default-col data-tablesaw-priority="6">Credit/Member</th>
	                        ...
	                        <tbody>
	                        	...
	                        	<?php $__currentLoopData = $view_sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sessions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		                            <tr>
		                                ...
		                                <td><?php echo e($sessions->max_member_sessions); ?></td>
		                                <td><?php echo e($sessions->credit_member_sessions); ?></td>
