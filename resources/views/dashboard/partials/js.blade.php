...
<script src="{{ URL::asset('public/dashboard/plugins/raphael/raphael-min.js') }}"></script>
<script src="{{ URL::asset('public/dashboard/plugins/morrisjs/morris.min.js') }}"></script>
<script src="{{ URL::asset('public/dashboard/plugins/styleswitcher/jQuery.style.switcher.js') }}"></script>
<script src="{{ URL::asset('public/dashboard/plugins/tablesaw-master/dist/tablesaw.js') }}"></script>
<script src="{{ URL::asset('public/dashboard/plugins/tablesaw-master/dist/tablesaw-init.js') }}"></script>
<script src="{{ URL::asset('public/dashboard/js/jasny-bootstrap.js') }}"></script>
<script src="{{ URL::asset('public/dashboard/plugins/Magnific-Popup-master/dist/jquery.magnific-popup.min.js') }}"></script>
<script src="{{ URL::asset('public/dashboard/plugins/Magnific-Popup-master/dist/jquery.magnific-popup-init.js') }}"></script>
<script src="{{ URL::asset('public/dashboard/plugins/jqueryui/jquery-ui.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('public/dashboard/plugins/select2/dist/js/select2.full.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('public/dashboard/plugins/datetimepicker/bootstrap-datetimepicker.min.js') }}"></script>
<script src="{{ URL::asset('public/dashboard/plugins/templateEditor/ckeditor/ckeditor.js') }} "></script>  
<script src="{{ URL::asset('public/dashboard/plugins/price/jquery.price.js') }} "></script>  
<script type="text/javascript" src="{{ URL::asset('public/dashboard/plugins/chained/jquery.chained.js') }}"></script>
<script type="text/javascript" src="{{{ URL::asset('public/dashboard/plugins/daterangepicker/moment.min.js')}}}"></script>
<script type="text/javascript" src="{{{ URL::asset('public/dashboard/plugins/daterangepicker/daterangepicker.js')}}}"></script>
		...
		//Menu
			$('#order_page').sortable({
				...
				update: function(event, ui) {
					...
					$.post("{{URL::asset('/').'dashboard/menu/processorder' }}", { type: "orderPage", namePage: $('#order_page').sortable('serialize') } );
				}
			});
