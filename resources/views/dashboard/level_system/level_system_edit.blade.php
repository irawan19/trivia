	...
	<div class="container-fluid">
	    <div class="row">
	        <div class="col-12">
	            <div class="card">
	                <div class="card-body">
			            <form class="form-horizontal m-t-40" action="{{ URL('dashboard/level_system/processedit/'.$edit_level_systems->id_level_systems) }}" method="POST">
							{{ csrf_field() }}
	                        <div class="form-group {{ Shwetech::errorStyleGroup($errors->first('name_level_systems')) }}">
	                            ...
	                            <input id="name_level_systems" type="text" name="name_level_systems" class="form-control {{ Shwetech::errorStyleFormControl($errors->first('name_level_systems')) }}" value="{{ Request::old('name_level_systems') == '' ? $edit_level_systems->name_level_systems : Request::old('name_level_systems') }}" placeholder="Name" required autofocus>
													...
													<td align="center">
														@foreach($add_features as $features_view)
															...
															@if($check_features == 'view')
																...
																<input type="checkbox" id="md_checkbox_{{ $no_checkbox }}_features_view" class="chk-col-black sub" name="features_id[]" value="{{ $features_view->id_features }}" {{ $checked }} />
													...
													<td align="center">
														@foreach($add_features as $features_read)
															...
															@if($check_features == 'read')
																...
																<input type="checkbox" id="md_checkbox_{{ $no_checkbox }}_features_read" class="chk-col-amber sub" name="features_id[]" value="{{ $features_read->id_features }}" {{ $checked }} />
													...
													<td align="center">
														@foreach($add_features as $features_add)
															...
															@if($check_features == 'add')
																...
																<input type="checkbox" id="md_checkbox_{{ $no_checkbox }}_features_add" class="chk-col-cyan sub" name="features_id[]" value="{{ $features_add->id_features }}" {{ $checked }} />
													...
													<td align="center">
														@foreach($add_features as $features_delete)
															...
															@if($check_features == 'delete')
																...
																<input type="checkbox" id="md_checkbox_{{ $no_checkbox }}_features_delete" class="chk-col-red sub" name="features_id[]" value="{{ $features_delete->id_features }}" {{ $checked }} />
													...
													<td align="center">
														@foreach($add_features as $features_print)
															...
															@if($check_features == 'print')
																...
																<input type="checkbox" id="md_checkbox_{{ $no_checkbox }}_features_print" class="chk-col-green sub" name="features_id[]" value="{{ $features_print->id_features }}" {{ $checked }} />
