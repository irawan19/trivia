                ...
                <div class="card">
                    <div class="card-body">
    		            ...
    		            <form class="form-horizontal m-t-40" action="{{ URL('dashboard/sessions/processadd') }}" method="POST">
                            ...
                            <div class="input-group {{ Shwetech::errorStyleFormControl($errors->first('rtp_sessions')) }}">
                                <input id="rtp_sessions" type="text" name="rtp_sessions" class="form-control number_format {{ Shwetech::errorStyleFormControl($errors->first('rtp_sessions')) }}" value="{{ Request::old('rtp_sessions') }}" placeholder="Return To Player" required aria-describedby="basic-addon2">
