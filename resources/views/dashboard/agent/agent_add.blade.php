            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
    		            ...
    		            <form class="form-horizontal m-t-40" action="{{ URL('dashboard/agent/processadd') }}" method="POST">
    						{{ csrf_field() }}
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-12">
	                                    <select name="sub_users_id" class="custom-select col-12 select2" id="inlineFormCustomSelect" required autofocus>
	                                        ...
	                                        @foreach($add_sub_users as $sub_users)
	                                            <option value="{{ $sub_users->id }}" {{ Request::old('sub_users_id') == $sub_users->id ? $select='selected' : $select='' }}>{{ $sub_users->name }}</option>
	                                        @endforeach
	                                    </select>
                            ...
                            <div class="form-group {{ Shwetech::errorStyleGroup($errors->first('max_group_users')) }}">
                                ...
                                <input id="max_group_users" type="text" name="max_group_users" class="form-control number_format {{ Shwetech::errorStyleFormControl($errors->first('max_group_users')) }}" value="{{ Request::old('max_group_users') }}" placeholder="Total Group" required>
